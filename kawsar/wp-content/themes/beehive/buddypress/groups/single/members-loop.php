...
<?php if ( bp_group_has_members( bp_ajax_querystring( 'group_members' ) ) ) : ?>
	...
	<ul id="members-list" class="<?php bp_nouveau_loop_classes(); ?>">
		...
		while ( bp_group_members() ) :
			...
			<li <?php bp_member_class( array( beehive_add_reveal_animation( 'item-entry', false ) ) ); ?> data-bp-item-id="<?php echo esc_attr( bp_get_group_member_id() ); ?>" data-bp-item-component="members">
