<?php
/**
 * Template for editing single media
 *
 * @package WordPress
 */
	...
	if ( have_rtmedia() ) :
		...
		if ( rtmedia_edit_allowed() ) {
			...
			<div class="rtmedia-single-edit-title-container">
				<h3 class="rtm-gallery-title edit-title"><?php esc_html_e( 'Edit Media', 'buddypress-media' ); ?></h3>
			</div>
			<form method="post" action="" name="rtmedia_media_single_edit" id="rtmedia_media_single_edit" class="rtm-form">
				<div class="rtmedia-editor-main">
					...
					<div class="rtmedia-editor-buttons rtm-submit">
